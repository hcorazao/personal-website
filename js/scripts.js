...
$(function() {
  ...
  wind.on("scroll", function() {
    ...
    if (bodyScroll > 100) {
      ...
      darkbg.attr('src', 'img/personal-logo-light.png');
      whitebg.attr('src', 'img/logo-dark.png');
      scrollbg.attr('src', 'img/personal-logo-light.png');
      lightbg.attr('src', 'img/logo-dark.png');
    } else {
      navbar.removeClass("nav-scroll");
      logo.attr('src', 'img/personal-logo-light.png');
      lightbg.attr('src', 'img/logo-dark.png');
